...
This document describes the governance model for the Value-Context Protocol (VCP)
specification, schemas, reference implementations, and associated tooling.

VCP is developed in the open under neutral governance. This document establishes
the structures and processes that ensure the protocol serves the interests of the
entire ecosystem -- implementors, AI providers, end users, and the broader
community of people building ethical AI infrastructure.
...
*This document is effective as of its merge date and supersedes all prior
governance arrangements for the Value-Context Protocol.*
